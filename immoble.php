...
<link rel="icon" type="image/png" href="/assets/favicon.png?v=90aac445">
<link rel="preload" href="/assets/fonts/fraunces-var-latin.woff2?v=48642176" as="font" type="font/woff2" crossorigin>
<link rel="preload" href="/assets/fonts/manrope-var-latin.woff2?v=b4295101" as="font" type="font/woff2" crossorigin>
<link rel="stylesheet" href="/assets/fonts.css?v=69dae886">
<link rel="stylesheet" href="/assets/site.css?v=385ad45e">
</head>
<body id="top">
...
<nav class="nav" id="nav" aria-label="Principal">
  <a class="nav__brand" href="index.html" aria-label="Top House Real Estate, inici">
    <img class="mark" src="/assets/logo.png?v=e80d112c" width="256" height="256" alt="" aria-hidden="true" decoding="async">
  ...
  <div class="nav__links">
    <a href="index.html#vender">Vendre</a>
    <a href="comprar.html">Comprar</a>
    <a href="llogar.html">Llogar</a>
    <a href="index.html#valorar">Valoració</a>
    <a href="index.html#servicios">Serveis</a>
    <a href="index.html#contacto">Contacte</a>
  </div>
  <div class="nav__actions">
    <div class="lang" role="group" aria-label="Idioma"><span class="lang__on" aria-current="true"><abbr title="Català">CA</abbr></span><a href="/es/inmueble.php" hreflang="es" lang="es"><abbr title="Castellano">ES</abbr></a><a href="/en/property.php" hreflang="en" lang="en"><abbr title="English">EN</abbr></a></div>
    <a class="btn btn--ghost nav__tel" href="tel:+34605273150">605 27 31 50</a>
    <a class="btn btn--solid" href="index.html#contacto">Demanar la meva valoració</a>
  </div>
</nav>
...
<section class="cart__head">
  <p class="kicker">Immoble</p>
  <h1 class="d1">Aquest immoble ja no està publicat</h1>
  <p class="lede">Pot ser que s’hagi venut o que l’hàgim retirat. Bona part del que venem es tanca abans d’arribar a publicar-se, així que truqui’ns i li diem què tenim de semblant.</p>
  <p class="fitxa__acciones">
    <a class="btn btn--solid btn--lg" href="<?php echo h($volver); ?>">Veure el que tenim</a>
...
<article class="fitxa" data-ref="<?php echo h($n['ref']); ?>"
  ...
  <p class="fitxa__volver"><a href="<?php echo h($volver); ?>">Tornar a la llista</a></p>
  ...
  <?php if (count($fotos)) { ?>
  <section class="fitxa__galeria" aria-label="Fotografies">
  ...
  <section class="fitxa__cos">
    <div class="fitxa__principal">
      <ul class="fitxa__datos">
        <?php if ($n['m2']) { ?><li><span>Superfície</span> <b><?php echo (int) $n['m2']; ?> m²</b></li><?php } ?>
        <?php if ($n['hab']) { ?><li><span>Habitacions</span> <b><?php echo (int) $n['hab']; ?></b></li><?php } ?>
        <?php if ($n['banys']) { ?><li><span>Baños</span> <b><?php echo (int) $n['banys']; ?></b></li><?php } ?>
        <li><span>Referència</span> <b><?php echo h($n['ref']); ?></b></li>
        <?php $en = porIdioma($n, 'energia', $L); if ($en !== '') { ?>
        <li><span>Qualificació energètica</span> <b><?php echo h($en); ?></b></li>
        <?php } ?>
      </ul>
    ...
    <aside class="fitxa__lateral">
      <form class="form fitxa__form" id="form" novalidate>
        <p class="kicker">Demanar visita</p>
        <h2 class="d3">El vol veure?</h2>
        <p class="fitxa__formnota">Deixi’ns el seu telèfon i el truquem avui per acordar el dia.</p>

        <div class="field field--wide">
          <label for="f-nombre">Nom</label>
          <input id="f-nombre" name="nombre" type="text" autocomplete="name" required placeholder="El seu nom">
        </div>
        <div class="field field--wide">
          <label for="f-tel">Telèfon</label>
          <input id="f-tel" name="telefono" type="tel" autocomplete="tel" required placeholder="Per trucar-li avui">
        </div>
        <div class="field field--wide">
          <label for="f-msg">Missatge <span class="opt">(opcional)</span></label>
          <textarea id="f-msg" name="mensaje" rows="3" placeholder="Expliqui’ns el que vulgui"></textarea>
        </div>
        <div class="field field--wide field--consent">
          <label class="consent" for="f-ok">
            ...
            <span>He llegit i accepto la política de privacitat. En enviar, les meves dades arriben a Top House per correu i s’obre WhatsApp, que és un servei de Meta.</span>
          </label>
        </div>
        ...
        <button class="btn btn--solid btn--lg form__go" type="submit">Demanar visita</button>
        <p class="form__note mono">La seva sol·licitud ens arriba per correu i s’obre WhatsApp amb el missatge ja escrit.</p>
        <p class="form__ok" id="form-ok" role="status" hidden>Rebut. S’obre WhatsApp amb el seu missatge ja escrit perquè només hagi de prémer enviar.</p>
      </form>

      <p class="fitxa__tel">
        O truqui’ns ara: <a href="tel:+34605273150">605 27 31 50</a>
      </p>
    </aside>
  </section>
</article>
...
<footer class="foot">
  <div class="foot__top">
    ...
    <div class="foot__cols">
      ...
      <div>
        ...
        <p><a href="legal.html#aviso-legal">Avís legal</a><br>
           <a href="legal.html#privacidad">Privacitat</a><br>
  ...
  <div class="foot__bar">
    ...
    <p class="foot__note">Preus i superfícies orientatius. La informació definitiva de cada immoble es lliura per escrit abans de qualsevol reserva.</p>
  </div>
</footer>
<script src="/assets/idioma.js?v=e0ba2e65" defer></script>
<script src="/assets/base.js?v=aa4a05d7" defer></script>
<script src="/assets/extras.js?v=da2cdee0" defer></script>
<script src="/assets/aviso.js?v=17fcfaae" defer></script>
<script src="/assets/fitxa.js?v=b8a25cd1" defer></script>
</body>
</html>

...
<nav class="nav" id="nav" aria-label="Main">
  <a class="nav__brand" href="index.html" aria-label="Top House Real Estate, home">
  ...
  <div class="nav__links">
    <a href="index.html#vender">Sell</a>
    <a href="buy.html">Buy</a>
    <a href="rent.html">Rent</a>
    <a href="index.html#valorar">Valuation</a>
    <a href="index.html#servicios">Services</a>
    <a href="index.html#contacto">Contact</a>
  </div>
  <div class="nav__actions">
    <div class="lang" role="group" aria-label="Idioma"><a href="/immoble.php" hreflang="ca" lang="ca"><abbr title="Català">CA</abbr></a><a href="/es/inmueble.php" hreflang="es" lang="es"><abbr title="Castellano">ES</abbr></a><span class="lang__on" aria-current="true"><abbr title="English">EN</abbr></span></div>
    <a class="btn btn--ghost nav__tel" href="tel:+34605273150">605 27 31 50</a>
    <a class="btn btn--solid" href="index.html#contacto">Book my valuation</a>
  </div>
</nav>
...
<section class="cart__head">
  ...
  <h1 class="d1">This property is no longer listed</h1>
  <p class="lede">It may have been sold or withdrawn. A good part of what we sell closes before it is ever listed, so call us and we will tell you what we have that is similar.</p>
  <p class="fitxa__acciones">
    <a class="btn btn--solid btn--lg" href="<?php echo h($volver); ?>">See what we have</a>
...
<article class="fitxa" data-ref="<?php echo h($n['ref']); ?>"
  ...
  <p class="fitxa__volver"><a href="<?php echo h($volver); ?>">Back to the list</a></p>
  ...
  <?php if (count($fotos)) { ?>
  <section class="fitxa__galeria" aria-label="Photographs">
  ...
  <section class="fitxa__cos">
    <div class="fitxa__principal">
      <ul class="fitxa__datos">
        <?php if ($n['m2']) { ?><li><span>Floor area</span> <b><?php echo (int) $n['m2']; ?> m²</b></li><?php } ?>
        <?php if ($n['hab']) { ?><li><span>Bedrooms</span> <b><?php echo (int) $n['hab']; ?></b></li><?php } ?>
        <?php if ($n['banys']) { ?><li><span>Baños</span> <b><?php echo (int) $n['banys']; ?></b></li><?php } ?>
        <li><span>Reference</span> <b><?php echo h($n['ref']); ?></b></li>
        <?php $en = porIdioma($n, 'energia', $L); if ($en !== '') { ?>
        <li><span>Energy rating</span> <b><?php echo h($en); ?></b></li>
        <?php } ?>
      </ul>
    ...
    <aside class="fitxa__lateral">
      <form class="form fitxa__form" id="form" novalidate>
        <p class="kicker">Request a viewing</p>
        <h2 class="d3">Would you like to see it?</h2>
        <p class="fitxa__formnota">Leave us your phone number and we will call you today to arrange a day.</p>

        <div class="field field--wide">
          <label for="f-nombre">Name</label>
          <input id="f-nombre" name="nombre" type="text" autocomplete="name" required placeholder="Your name">
        </div>
        <div class="field field--wide">
          <label for="f-tel">Phone</label>
          <input id="f-tel" name="telefono" type="tel" autocomplete="tel" required placeholder="So we can call you today">
        </div>
        <div class="field field--wide">
          <label for="f-msg">Message <span class="opt">(optional)</span></label>
          <textarea id="f-msg" name="mensaje" rows="3" placeholder="Tell us whatever you like"></textarea>
        </div>
        <div class="field field--wide field--consent">
          <label class="consent" for="f-ok">
            ...
            <span>I have read and accept the privacy policy. On sending, my details reach Top House by email and WhatsApp opens, which is a Meta service.</span>
          </label>
        </div>
        ...
        <button class="btn btn--solid btn--lg form__go" type="submit">Request a viewing</button>
        <p class="form__note mono">Your enquiry reaches us by email, and WhatsApp opens with the message already written.</p>
        <p class="form__ok" id="form-ok" role="status" hidden>Received. WhatsApp opens with your message already written, so all you have to do is press send.</p>
      </form>

      <p class="fitxa__tel">
        Or call us now: <a href="tel:+34605273150">605 27 31 50</a>
      </p>
    </aside>
  </section>
</article>
...
<footer class="foot">
  <div class="foot__top">
    ...
    <div class="foot__cols">
      ...
      <div>
        ...
        <p><a href="legal.html#aviso-legal">Legal notice</a><br>
           <a href="legal.html#privacidad">Privacy</a><br>
  ...
  <div class="foot__bar">
    ...
    <p class="foot__note">Prices and floor areas are indicative. Definitive details for each property are provided in writing before any reservation.</p>
  </div>
</footer>
